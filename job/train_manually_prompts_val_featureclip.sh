...
python3 /mnt/dolphinfs/hdd_pool/docker/user/hadoop-vacv/hancong/code/pretrain/ov-seg/zsseg.baseline/train_net.py --config-file /mnt/dolphinfs/hdd_pool/docker/user/hadoop-vacv/hancong/code/pretrain/ov-seg/zsseg.baseline/configs/coco-stuff-164k-156/zero_shot_proposal_classification_bs32_10k_featureclip.yaml --num-gpus 4 --eval-only --resume MODEL.CLIP_ADAPTER.CLIP_MODEL_NAME ${clipmodel} SOLVER.TEST_IMS_PER_BATCH 8 INPUT.DATASET_MAPPER_NAME ${datamap}
