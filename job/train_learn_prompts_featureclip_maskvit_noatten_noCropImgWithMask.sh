...
outputDir="/mnt/dolphinfs/hdd_pool/docker/user/hadoop-vacv/hancong/code/pretrain/ov-seg/zsseg.baseline/output/promptproposal/1217/learnprompt_featureclip_maskvit_noattn_nocropimgwithmask"
CUDA_VISIBLE_DEVICES=0 python3 /mnt/dolphinfs/hdd_pool/docker/user/hadoop-vacv/hancong/code/pretrain/ov-seg/zsseg.baseline/train_net.py --config-file /mnt/dolphinfs/hdd_pool/docker/user/hadoop-vacv/hancong/code/pretrain/ov-seg/zsseg.baseline/configs/coco-stuff-164k-156/zero_shot_proposal_classification_learn_prompt_bs32_10k_featureclip.yaml --num-gpus 1 OUTPUT_DIR ${outputDir} TEST.EVAL_PERIOD 5000
