...
import sys
sys.path.append("/mnt/dolphinfs/hdd_pool/docker/user/hadoop-vacv/hancong/code/pretrain/ov-seg/zsseg.baseline/datasets")
import prepare_coco_stuff_164k_sem_seg as precoco

unseen_trID = [ precoco.full_clsID_to_trID[key] for key in precoco.novel_clsID]
